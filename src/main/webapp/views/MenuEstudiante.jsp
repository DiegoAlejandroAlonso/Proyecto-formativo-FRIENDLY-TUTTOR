...
<div class="container2">
        <aside>
            ...
            <div class="sidebar">
              ...
              <a href="UsuarioController?accion=editunicoEstudiante">
                    <span class="material-icons-sharp">receipt_long</span>
                    <h3>Ver Peril</h3>
                </a>
                <a href="UsuarioController?accion=openPassEstudiante">
                    <span class="material-icons-sharp">insights</span>
                    <h3>Cambio de contraseña</h3>
                </a>
                
               <a href="SolicitudController?accion=listarSolicitudesEstudiante">
                    <span class="material-icons-sharp">inventory</span>
                    <h3>Solicitud</h3>
                </a>
                 <a href="TutoriaController?accion=listarMenu">
                    <span class="material-icons-sharp">inventory</span>
                    <h3>tutorias publicadas</h3>
                </a>
                <a href="MaterialApoyoController?accion=listarMaterialPublicado">
                    <span class="material-icons-sharp">inventory</span>
                    <h3>Acceder a Material de apoyo</h3>
                </a>
            ...
            <div class="top">
                ...
                <div class="profile">
                    <div class="info">
                        ...
                        <small class="text-muted"><b>${us.rolUs.descripcionRol}${us.correoUsuario}</b></small>
                    </div>
