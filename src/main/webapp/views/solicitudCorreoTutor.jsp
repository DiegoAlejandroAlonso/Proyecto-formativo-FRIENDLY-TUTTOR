		...
		<tr>
			...
			<c:if test="${s.isEstado()==true}">
				<td>
					...
					<a  class="theme-toggler" onclick="cambiare(event,${s.getId()},${s.isEstado()},'SolicitudEnviada')" role="button"><i class=""></i>activa</a>
				</td>
			</c:if>
			
			<c:if test="${s.isEstado()==false}">
				<td>
					<a  class="theme-toggler" onclick="cambiare(event,${s.getId()},${s.isEstado()},'SolicitudEnviada')" role="button"><i class=""></i>inactiva</a>
				</td>
			</c:if>
